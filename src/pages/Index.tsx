...
const services = [
  ...
  const projects = [
  {
    ...
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRq_g_G2GqqnEEKy1NozJXmDsFiKbpdLqS9Dg&s',
    status: 'Ongoing',
  ...
  },
  {
    ...
    image: 'https://www.arylaguna.com/Karachi/public/assets/Images/april25.png',
    status: 'Ongoing',
 ...
 const clients = [
  ...
  <strong>QAAM ENTERPRISES Inc.</strong> is a premier civil and telecommunication firm specializing in commercial and industrial projects since 2009. Renowned for our unwavering commitment to <strong>quality, safety, and sustainability</strong>, we have established ourselves as a trusted leader in <strong>custom, industrial, commercial, and residential developments</strong>—with a strong focus on green building initiatives.
</p>

<p className="text-gray-700 mb-6 leading-relaxed">
  Founded in 2009, QAAM Enterprises has been at the forefront of <strong>geomembrane and geotextile solutions</strong> in India and Pakistan. What began as a vision to provide reliable environmental containment solutions has now grown into a name recognized across major infrastructure and utility sectors.
</p>

<p className="text-gray-700 mb-6 leading-relaxed">
  With over 15 years of industry experience, we have successfully delivered hundreds of projects including <strong>water treatment plants, canal lining, industrial waste containment systems, and networking infrastructure installations</strong>. Our strength lies in delivering <strong>tailored, innovative solutions</strong> that adapt to each client’s unique requirements—setting us apart in the industry.
</p>
...
<ul className="space-y-2 text-gray-300">
  ...
  <li>Right of Entry (RoE) & Hardscaping</li>
  <li>Internal/External Telecommunication</li>
  <li>Networking & CCTV Surveillance</li>
</ul>
            </div>
          </div>
